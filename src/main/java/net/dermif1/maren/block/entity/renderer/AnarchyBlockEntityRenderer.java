...
public class AnarchyBlockEntityRenderer implements BlockEntityRenderer<AnarchyBlockEntity> {
    public AnarchyBlockEntityRenderer(BlockEntityRendererProvider.Context context) {

    }

    @Override
    public void render(AnarchyBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack,
