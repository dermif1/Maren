...
import net.dermif1.maren.lang.en_us;
import net.dermif1.maren.lang.uk_ua;
...
@EventBusSubscriber(modid = Maren.MOD_ID)
public class DataGenerators {
    ...
    public static void gatherClientData(GatherDataEvent.Client event) {
        ...
        generator.addProvider(true, new uk_ua(packOutput));
    }
}
